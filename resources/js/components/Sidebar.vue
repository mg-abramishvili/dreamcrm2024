<template>
    <div class="sidebar">
        ...
        <ul>
         ...
         <button @click="darkModeToggle()" class="btn btn-theme-toggler">
             <svg v-show="theme == 'dark-theme'" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-sun-fill" viewBox="0 0 16 16">
             ...
             <svg v-show="theme == 'light-theme'" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-moon-fill" viewBox="0 0 16 16">
...
export default {
    ...
    methods: {
        userAvatar() {
            return this.$store.state.user.avatar ? this.$store.state.user.avatar : '/img/ava.jpg'
        },
        darkModeToggle() {
            if(this.theme == 'light-theme') {
                axios.put('/api/theme', {theme: 'dark'})
            ...
            if(this.theme == 'dark-theme') {
                axios.put('/api/theme', {theme: 'light'})

                this.theme = 'light-theme'

                document.body.classList.remove('dark-theme')
                return document.body.classList.add('light-theme')
            }
        },
    }
}
