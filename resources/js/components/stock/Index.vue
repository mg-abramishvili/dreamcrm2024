<template>
    <div class="header">
        ...
        <div class="header-buttons">
            <a v-if="$store.getters.userHasPermission('stock', 'create')" href="#" class="btn btn-primary">Новая категория</a>
        </div>
    </div>
    ...
    <div class="content">
        ...
        <div v-if="!views.loading" class="content-folders">
            <div v-for="category in categories" class="content-folder">
                <RouterLink :to="{name: 'StockCategory', params: {id: category.id}}">
